...
namespace ElfjaneEnjoy.DB
{
    internal class Config
    {
        ...
        public static string DefaultMinigameWordList = "[{ \"en\": \"apple\", \"zh\": \"蘋果\" },{ \"en\": \"banana\", \"zh\": \"香蕉\" },{ \"en\": \"orange\", \"zh\": \"橘子\" },{ \"en\": \"computer\", \"zh\": \"電腦\" },{ \"en\": \"keyboard\", \"zh\": \"鍵盤\" }]";

        public static void CreateMinigameWordListConfig()
        {
            File.WriteAllText(Path.Combine(ConfigPath, "minigame_wordlist.json"), DefaultMinigameWordList);
        }
        ...
        public static void CheckAndCreateConfigs()
        {
            ...
            if (!File.Exists(Path.Combine(ConfigPath, "minigame_wordlist.json")))
            {
                CreateMinigameWordListConfig();
            }
        }
    }
}
