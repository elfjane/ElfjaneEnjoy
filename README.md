# ElfjaneEnjoy - Mod Server for V Rising
...
-   Name change from Notify to ElfjaneEnjoy
...
To configure the default messages in case you do not have personalized messages per player you only have to edit the configuration file that is in **/BepInEx/config/ElfjaneEnjoy/default_announce.json**
...
To configure the customize messages per player connected, you only have to edit the configuration file that is in **/BepInEx/config/ElfjaneEnjoy/users_online.json**
...
To configure the customize messages per player disconnected, you only have to edit the configuration file that is in **/BepInEx/config/ElfjaneEnjoy/users_offline.json**
...
To translate the name of VBlood boss, you only have to edit the configuration file that is in **/BepInEx/config/ElfjaneEnjoy/prefabs_names.json**
...
To ignore the notification of the death of a VBlood, you only have to edit the configuration file that is in **/BepInEx/config/ElfjaneEnjoy/prefabs_names_ignore.json** and set the vblood prefab you want to true.
...
**/BepInEx/config/ElfjaneEnjoy/prefabs_names_ignore.json**
...
To configure the Auto Announce messages you must edit the configuration file that is in **/BepInEx/config/ElfjaneEnjoy/auto_announcer_messages.json**

```json
[
    ["<color=#FFFFFF> Message 1 Line 1</color>", "<color=#B22222><i>-Message 1 Line 2</i></color>", "<color=#00FFFF>Message 1 Line 3</color>", "<color=#FFFFFF>Message 1 Line 4</color>"],
    ["Message 2 Line 1", "Message 2 Line 2", "Message 2 Line 3", "Message 2 Line 4"]
]
```
...
To configure the Message of the day you must edit the configuration file that is in **/BepInEx/config/ElfjaneEnjoy/message_of_the_day.json**

```json
["<color=#FFFFFF>Hello <i>#user#</i> this is Message of the day Line 1</color>", "<color=#B22222>Message of the day Line 2</color>", "<color=#00FFFF>Message of the day Line 3</color>", "<color=#FFFFFF>Message of the day Line 4</color>"]
```
...
If you want to do it by hand you just have to edit the **/BepInEx/config/ElfjaneEnjoy/vbloodannounce_ignore_users.json** file to add or remove players
